...
urlpatterns = [
    ...
    path('<int:pk>/termination-dashboard/', views.termination_dashboard, name='termination_dashboard'),
    path('<int:pk>/process-refund/', views.process_refund, name='process_refund'),
